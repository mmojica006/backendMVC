        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="box box-default ">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">AgroNegocio</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip"
                                    title="Collapse">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control cambioScript" rows="5" id="agroNegocio" name="agroNegocio">

                                 <?php echo $dataProductos["AgroNegocio"]; ?>
                    ...
                    <div class="box-footer">
                        <button type="button" id="guardarAgroNegocio" class="btn btn-primary pull-right">Guardar
                        </button>
                    </div>
