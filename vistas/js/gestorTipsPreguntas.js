/**
 * Created by Administrador on 2/26/2018.
 */
loadCKEbasic("tipsFinan");
loadCKEbasic("preguntas");


$("#guardarTips").click(function () {

    for (var instanceName in CKEDITOR.instances) {
        CKEDITOR.instances[instanceName].updateElement();
    }

    var descTips = $("#tipsFinan").val();


    var datos = new FormData();
    datos.append("tips", descTips);


    $.ajax({
        url: "ajax/tipsPreguntas.ajax.php",
        method: "POST",
        data: datos,
        cache: false,
        contentType: false,
...
$("#guardarPreguntas").click(function () {
    ...
    var datos = new FormData();
    datos.append("preguntas", preguntas);
